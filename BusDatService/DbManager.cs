...
{
	/// <summary>
	/// Summary description for DbControler.
	/// </summary>
	public class DbManager : System.ComponentModel.Component
	{
		#region Private Fields
		public string strSql = "";
		private System.Data.SqlClient.SqlCommand cmdHotele;
		...
		private int Execut1()
		{
			...
			{
				this.conn.Open();
				this.cmdHotele.CommandText = this.strSql;
				int p = cmdHotele.ExecuteNonQuery();
				this.conn.Close();
				return 0;
			}
		...
		private SqlDataReader Execut2()
		{
			try
			{
				this.conn.Open();
				this.cmdHotele.CommandText = this.strSql;
				SqlDataReader reader = cmdHotele.ExecuteReader();
				return reader;
			}
			catch (System.Data.SqlClient.SqlException ex)
			{
		...
		{
			this.cmdHotele = new System.Data.SqlClient.SqlCommand();
			this.conn = new System.Data.SqlClient.SqlConnection();
			// 
			// cmdHotele
			// 
			this.cmdHotele.Connection = this.conn;
			// 
			// conn
			// 
//			this.conn.ConnectionString = "workstation id=(LOCAL);packet size=4096;user id=sa;data source=\"(LOCAL)\\HM\";persist s" +
//				"ecurity info=True;initial catalog=Hotele;password=vision";
//			this.conn.ConnectionString = "workstation id=ERMOND;packet size=4096;user id=sa;data source=\"ERMOND\\HM\";persist s" +
//				"ecurity info=True;initial catalog=Hotele;password=vision";
			this.conn.ConnectionString = "workstation id=BESA;packet size=4096;user id=sa;data source=\"BESA\";persist s" +
				"ecurity info=True;initial catalog=Hotele;password=vision";
