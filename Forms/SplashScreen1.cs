...
{
	/// <summary>
	/// Summary description for SplashScreen1.
	/// </summary>
	public class SplashScreen1 : System.Windows.Forms.Form
	{
		// Threading
		static SplashScreen1 ms_frmSplash = null;
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(SplashScreen1));
			...
			this.lblStatus.Location = new System.Drawing.Point(100, 152);
			...
			this.pnlStatus.Location = new System.Drawing.Point(100, 176);
			this.pnlStatus.Name = "pnlStatus";
			this.pnlStatus.Size = new System.Drawing.Size(296, 18);
			...
			this.lblTimeRemaining.Location = new System.Drawing.Point(100, 204);
			this.lblTimeRemaining.Name = "lblTimeRemaining";
			this.lblTimeRemaining.Size = new System.Drawing.Size(279, 16);
			this.lblTimeRemaining.TabIndex = 2;
			this.lblTimeRemaining.Text = "Koha e mbetur";
		...
		// launch the SplashScreen1.
		static public void ShowSplashScreen()
		{
			// Make sure it's only launched once.
			if( ms_frmSplash != null )
				return;
			ms_oThread = new Thread( new ThreadStart(SplashScreen1.ShowForm));
		...
		static public SplashScreen1 SplashForm 
		{
			get
			{
				return ms_frmSplash;
		...
		{
			ms_frmSplash = new SplashScreen1();
			Application.Run(ms_frmSplash);
		}

		// A static method to close the SplashScreen1
		static public void CloseForm()
		{
			if( ms_frmSplash != null && ms_frmSplash.IsDisposed == false )
			{
				...
				ms_frmSplash.BackColor = SystemColors.GrayText;
			}
		...
		private void timer1_Tick(object sender, System.EventArgs e)
		{
			...
			if( m_bFirstLaunch == false && m_dblLastCompletionFraction < m_dblCompletionFraction )
			{
				...
				if( width > 0 && height > 0 )
				{
					...
					if( iSecondsLeft == 1 )
						lblTimeRemaining.Text = string.Format( "Edhe nje sekonde nga hapja e programit");
					else
						lblTimeRemaining.Text = string.Format( "{0} sekonda deri ne hapjen e programit", iSecondsLeft);
